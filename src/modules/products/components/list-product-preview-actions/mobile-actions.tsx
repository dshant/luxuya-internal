    ...
    return variantPrice || cheapestPrice || null
      ...
      const outOfStockSizes = useMemo(() => {
        return product.variants
          ?.filter((variant: { manage_inventory: any; inventory_quantity: any }) => variant.manage_inventory && (variant.inventory_quantity || 0) <= 0)
          .map((variant: { options: HttpTypes.StoreProductOptionValue[] | null }) => optionsAsKeymap(variant.options)) || []
      }, [product.variants])
