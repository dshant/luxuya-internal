      ...
      <div className="hidden small:block">
        <div className="text-xl-semi flex justify-between items-center mb-4">
          <span data-testid="welcome-message" data-value={customer?.first_name}>
            {customer?.first_name && <TranslatedText text={"Hello " + customer?.first_name} />}
          </span>
          <span className="text-small-regular text-ui-fg-base">
           <TranslatedText text="Signed in as:" />{" "}
            <span
              className="font-semibold"
              data-testid="customer-email"
              data-value={customer?.email}
            >
            {customer?.email && <TranslatedText text={customer?.email} /> }
            </span>
          </span>
        </div>
              ...
              >
                {orders && orders.length > 0 ? (
                          ...
                          <Container className="bg-gray-50 flex justify-between items-center p-4">
                            <div className="grid grid-cols-3 grid-rows-2 text-small-regular gap-x-4 flex-1">
                              <span className="font-semibold">
                                <TranslatedText text="Date placed" />
                              </span>
                              <span className="font-semibold">
                                <TranslatedText text="Order number" />
                              </span>
                              <span className="font-semibold">
                            ...
                            >
                              <span className="sr-only">
                               <TranslatedText text="Go to order" /> #{order.display_id}
                              </span>
                  ...
                  <span data-testid="no-orders-message">
                    <TranslatedText text="No recent orders" />
                  </span>
                )}
              </ul>
            </div>
