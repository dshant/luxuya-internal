...
const Item = ({ item, type = "full", currencyCode }: ItemProps) => {
  ...
  return (
    <div className='text-[#222]'>
      {!isPreview && (
        <div className='flex items-start p-3 gap-4 sm:flex-row-reverse sm:justify-items-end'>
          <CircleAlert size={22} />
      ...
      <div
        className='border-t border-gray-300 py-6 px-[6px] w-full flex flex-col sm:flex-row gap-8 sm:gap-2 relative sm:justify-between'
        style={
          isPreview
            ? {
                border: "none",
      ...
      >
        ...
        <div className='flex items-start gap-2 sm:justify-between sm:flex-1'>
          <LocalizedClientLink href={`/products/${item.product_handle}`}>
            <img
              ...
              className={`object-contain ${isPreview ? "w-32" : "w-48"}`}
              src={item.thumbnail}
            />
          </LocalizedClientLink>
            ...
            <div className='flex-1 flex sm:justify-center'>
              <div>
                ...
                <LocalizedClientLink
                  ...
                  className={clx("block", {})}
                >
                  <p className='leading-5 md:leading-6 text-[15px] mt-[6px]'>
                    {item.product_title && (
        ...
        <div
          className='flex items-start gap-2 sm:flex-row-reverse sm:justify-between sm:flex-1'
          style={
            isPreview
              ? {
          ...
          >
            <div
              className={`flex flex-col gap-2 ${
                isPreview ? "items-end" : "items-start"
              }`}
            >
