    ...
    <div className="flex flex-col gap-y-4">
      {status?.accept === "success" && (
        <Text className="text-emerald-500">
          <TranslatedText text="Order transferred successfully!" />
        </Text>
      )}
      {status?.decline === "success" && (
        <Text className="text-emerald-500">
          <TranslatedText text="Order transfer declined successfully!" /> 
        </Text>
      )}
      {status?.accept !== "success" && status?.decline !== "success" && (
        <div className="flex gap-x-4">
          ...
          >
            <TranslatedText text="Accept transfer" />
          </Button>
          <Button
            size="large"
            variant="secondary"
          ...
          >
           <TranslatedText text="Decline transfer" />
          </Button>
        </div>
      )}
      {errorMessage && <Text className="text-red-500"><TranslatedText text={errorMessage} /></Text>}
    </div>
  )
}
