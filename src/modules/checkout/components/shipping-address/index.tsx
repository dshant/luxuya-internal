...
const ShippingAddress = ({
  ...
  const validateField = (name: string, value: string) => {
    ...
    if (name === "shipping_address.phone" && value.trim().length < 8) {
      error = "Enter a valid phone number"
    }

    if (name === "shipping_address.country_code" && !value) {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols md:grid-cols-2 gap-4 mb-4">
        ...
        />
        <PhoneInput
          country={formData["shipping_address.country_code"]?.toLowerCase() || "us"}
          ...
          inputClass={`!w-full !h-10 !text-base rounded-md border ${errors["shipping_address.phone"]
            ? "!border-rose-500"
            : "!border-gray-200"
            } !bg-gray-100/50`}
