  ...
  "inline-flex items-center justify-center text-muted-foreground",
  {
    variants: {
      variant: {
        ...
        underline: "w-full bg-transparent space-x-5 p-0 border-b rounded-none",
  ...
  "inline-flex items-center justify-center whitespace-nowrap px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        underline:
          "rounded-none data-[state=active]:bg-transparent data-[state=active]:text-black data-[state=active]:shadow-none border-b-2 border-transparent data-[state=active]:border-black data-[state=inactive]:hover:text-black",
