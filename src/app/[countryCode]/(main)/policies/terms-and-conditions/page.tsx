...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms and Conditions | Luxury For You",
    description: "Clear, transparent, and hassle-free Terms and Conditions.",
    alternates: {
...
const TermsAndConditions = async (props: Props) => {
  ...
  return (
    <>
      <Head>
        <title>Terms Conditions - Luxury For You</title>
        <meta
          name="description"
          content="Learn about our terms and conditions at Luxury For You."
        />
        <script
      ...
      <div className="mx-auto max-w-2xl p-8">
        <h1 className="mb-4 text-2xl font-bold">
          <TranslatedTextServer text="Terms and Conditions" />
        </h1>
        <p className="mb-4">
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="OVERVIEW" />
        </h2>
        <p>
          <TranslatedTextServer
            text='This website is operated by Luxury For You. Throughout the site, the
        terms "we", "us" and "our" refer to Luxury
        For You. Luxury For You offers this website, including all information,
        ...
        conditions ("Terms of Service", "Terms"), including
        those additional terms and conditions and policies referenced herein
        and/or available by hyperlink. These Terms of Service apply to all users
        ...
        <p>
          <TranslatedTextServer
            text="Any new features or tools which are added to the current store shall
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 1 - ONLINE STORE TERMS" />
        </h2>
        <p>
          <TranslatedTextServer
        ...
        <p>
          <TranslatedTextServer
            text="You may not use our products for any illegal or unauthorized purpose nor
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 2 - GENERAL CONDITIONS" />
        </h2>
        <p>
          <TranslatedTextServer
        ...
        <p>
          <TranslatedTextServer
            text="You understand that your content (not including credit card
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION" />
        </h2>
        <p>
          <TranslatedTextServer
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES" />
        </h2>
        <p>
          <TranslatedTextServer text="Prices for our products are subject to change without notice." />
        </p>
        <p>
          <TranslatedTextServer
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 5 - PRODUCTS OR SERVICES (if applicable)" />
        </h2>
        <p>
          <TranslatedTextServer
            text="Certain products or Services may be available exclusively online through
        ...
        <p>
          <TranslatedTextServer
            text="We have made every effort to display as accurately as possible the
        ...
        <p>
          <TranslatedTextServer
            text="We reserve the right, but are not obligated, to limit the sales of our
        ...
        <p>
          <TranslatedTextServer
            text="We do not warrant that the quality of any products, Services,
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION" />
        </h2>
        <p>
          <TranslatedTextServer
            text="We reserve the right to refuse any order you place with us. We may, in
        ...
        <p>
          <TranslatedTextServer
            text="You agree to provide current, complete and accurate purchase and account
        ...
        <p>
          <TranslatedTextServer text="For more details, please review our Refund Policy." />
        </p>

        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 7 - OPTIONAL TOOLS" />
        </h2>
        <p>
          <TranslatedTextServer
            text="We may provide you with access to third-party tools over which we
        neither monitor nor have any control nor input."
          />
        </p>
        <p>
          <TranslatedTextServer
            text='You acknowledge and agree that we provide access to such tools "as
        ...
        <p>
          <TranslatedTextServer
            text="Any use by you of the optional tools offered through the site is
        ...
        <p>
          <TranslatedTextServer
            text="We may also, in the future, offer new Services and/or features through
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 8 - THIRD-PARTY LINKS" />
        </h2>
        <p>
          <TranslatedTextServer
            text="Certain content, products and Services available via our Service may
        include materials from third-parties."
          />
        </p>
        <p>
          <TranslatedTextServer
            text="Third-party links on this site may direct you to third-party websites
        ...
        <p>
          <TranslatedTextServer
            text="We are not liable for any harm or damages related to the purchase or use
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS" />
        </h2>
        <p>
          <TranslatedTextServer
            text="If, at our request, you send certain specific submissions (for example
        ...
        <p>
          <TranslatedTextServer
            text="We may, but have no obligation to, monitor, edit or remove content that
        ...
        <p>
          <TranslatedTextServer
            text="You agree that your comments will not violate any right of any
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 10 - PERSONAL INFORMATION" />
        </h2>
        <p>
          <TranslatedTextServer
            text="Your submission of personal information through the store is governed by
        our Privacy Policy, which can be viewed our Privacy Policy."
          />
        </p>

        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS" />
        </h2>
        <p>
          <TranslatedTextServer
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 12 - PROHIBITED USES" />
        </h2>
        <p>
          <TranslatedTextServer
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY" />
        </h2>
        <p>
          <TranslatedTextServer
        ...
        <p>
          <TranslatedTextServer
            text="In no case shall Luxury For You, our directors, officers, employees,
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 14 - INDEMNIFICATION" />
        </h2>
        <p>
          <TranslatedTextServer
            text="You agree to indemnify, defend and hold harmless Luxury For You and our
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 15 - SEVERABILITY" />
        </h2>
        <p>
          <TranslatedTextServer
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 16 - TERMINATION" />
        </h2>
        <p>
          <TranslatedTextServer
        ...
        <p>
          <TranslatedTextServer
            text="These Terms of Service are effective unless and until terminated by
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 17 - ENTIRE AGREEMENT" />
        </h2>
        <p>
          <TranslatedTextServer
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 18 - GOVERNING LAW" />
        </h2>
        <p>
          <TranslatedTextServer
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 19 - CHANGES TO TERMS OF SERVICE" />
        </h2>
        <p>
          <TranslatedTextServer
        ...
        <h2 className="mt-6 text-xl font-semibold">
          <TranslatedTextServer text="SECTION 20 - CONTACT INFORMATION" />
        </h2>
        <p>
          <TranslatedTextServer text="Questions about the Terms of Service should be sent to us at" />
          care@luxuryforyou.com.
        </p>
        <p>
          <TranslatedTextServer text="Our contact information is posted below:" />
        </p>
        <p>
          ...
          Business Email: <a href="/contact">care@luxuryforyou.com</a>
          <br />
          Business Phone Number: +1 (220) 235-4544
        </p>
      </div>
    </>
  )
